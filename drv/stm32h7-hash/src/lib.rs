...
impl Hash {
    ...
    pub fn update(&mut self, data: &[u8]) -> Result<(), HashError> {
        ...
        // Incoming data may not be aligned.
        //
        ...
        // TODO: How do the cool kids translate 4 unaligned bytes into a u32?
    ...
    pub fn finalize_sha256(&mut self, out: &mut [u8]) -> Result<(), HashError> {
        ...
        assert!(out.len() == result.hr[..].as_bytes().len());
        // len_mismatch_fail
        out.clone_from_slice(&result.hr[..].as_bytes());
